...
function scanSpellAuto(startIndex, attempt, counter)
  ...
  if (counter >= 5) then
    WoWeuCN_Scanner_wait(0.5, scanSpellAuto, startIndex + 150, attempt + 1, 0)
  else
    WoWeuCN_Scanner_wait(0.5, scanSpellAuto, startIndex, attempt + 1, counter + 1)
  end
end
...
function scanUnitAuto(startIndex, attempt, counter)
  ...
  if (counter >= 3) then
    WoWeuCN_Scanner_wait(0.5, scanUnitAuto, startIndex + 250, attempt + 1, 0)
  else
    WoWeuCN_Scanner_wait(0.5, scanUnitAuto, startIndex, attempt + 1, counter + 1)
  end
end
...
function scanItemAuto(startIndex, attempt, counter)
  ...
  if (counter >= 5) then
    WoWeuCN_Scanner_wait(0.5, scanItemAuto, startIndex + 150, attempt + 1, 0)
  else
    WoWeuCN_Scanner_wait(0.5, scanItemAuto, startIndex, attempt + 1, counter + 1)
  end
end
...
function scanAchivementAuto(startIndex, attempt, counter)
  ...
  if (counter >= 5) then
    WoWeuCN_Scanner_wait(0.5, scanAchivementAuto, startIndex + 150, attempt + 1, 0)
  else
    WoWeuCN_Scanner_wait(0.5, scanAchivementAuto, startIndex, attempt + 1, counter + 1)
  end
end
...
function scanQuestAuto(startIndex, attempt, counter)
...
function scanCacheAuto(startIndex, attempt, counter)
  ...
  if (counter == 0) then
    ...
    WoWeuCN_Scanner_QuestIndex = startIndex
    if (counter >= 5) then
      WoWeuCN_Scanner_wait(0.2, scanCacheAuto, startIndex + 150, attempt + 1, 0)
    else
      WoWeuCN_Scanner_wait(0.2, scanCacheAuto, startIndex, attempt + 1, counter + 1)
    end
end
