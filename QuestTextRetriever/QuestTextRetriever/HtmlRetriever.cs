...
namespace QuestTextRetriever
{
    public class HtmlRetriever
    {
        ...
        public HtmlRetriever(string dirPath, string templateFilePath)
        {
            m_dirPath = dirPath;
        ...
        public void ExecuteJson(string outputPath)
        {
            ...
            ReadObjectives(@"C:\Users\qqytqqyt\OneDrive\Documents\OneDrive\OwnProjects\WoWTranslator\QuestCompletist.lua", objectives);
            ReadObjectives(@"C:\Users\qqytqqyt\OneDrive\Documents\OneDrive\OwnProjects\WoWTranslator\WoWeuCN_Quests_beta.lua", objectives);
            ...
            foreach (var filePath in dirPath.GetFiles(@"*.json"))
            {
                ...
                questObject.Description = questApi.Description?.Replace("\"", string.Empty).Replace("“", string.Empty).Replace("”", string.Empty);
