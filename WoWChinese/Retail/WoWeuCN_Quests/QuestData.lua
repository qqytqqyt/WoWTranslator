WoWeuCN_Quests_base = "11.0.2.56071";   -- version
WoWeuCN_Quests_date = "2024-08-08"; -- date of creation base

WoWeuCN_Quests_lang = "CN";      -- language

WowenCN_Quests_WeekDiff = 86400

-- Localization
WoWeuCN_Quests_Messages = {   
    loaded     = "加载完成", 
    isactive   = "已启用", 
    isinactive = "未启用", 
    missing    = "无可用翻译", 
