...
function QTR_SlashCommand(msg)
   ...
   elseif (msg=="scan" or msg=="SCAN") then
      if (qcQuestToolTips == nil) then
        qcQuestToolTips = {} 
      end
      if (qcQuestIndex == nil) then
        qcQuestIndex = 1
      end
      for i = qcQuestIndex, qcQuestIndex + 500 do
        ...
        if (text ~= '' and text ~= nil) then
          qcQuestToolTips[i .. ''] = text
          print(i)
        end
      end
      qcQuestIndex = qcQuestIndex + 500
   elseif (msg=="") then
